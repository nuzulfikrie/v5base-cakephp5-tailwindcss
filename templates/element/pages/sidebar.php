<?php echo $this->Sidebar->beginSidebar(); ?>
<li>
...
<?php
// Example of a single element sidebar link
echo $this->Sidebar->singleElementSidebar([
  'icon' => 'dashboard', // Assuming you have an IconHelper that handles this
  'title' => 'Dashboard',
  'controller' => 'Pages',
  'action' => 'display',
  'params' => ['dashboard']
...
<div class="absolute bottom-0 left-0 justify-center hidden w-full p-4 space-x-4 bg-white lg:flex dark:bg-gray-800" sidebar-bottom-menu>
  ...
  <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700" id="language-dropdown">
    <ul class="py-1" role="none">
      ...
      <?php echo $this->Sidebar->endSidebar(); ?>